/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 1b9193d188043d00cd74312de537f8b1)
// Runtime types generated with workerd@1.20260828.1 2025-08-01 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	MEDIA: R2Bucket;
	ANALYTICS_RAW: R2Bucket;
	DB: D1Database;
	ANALYTICS_DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	APP_URL: "https://quienlohace-marketplace.akiens-dev.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "ANALYTICS_ENABLED">> {}
}
